...
class FtbSlot(val offsetLen: Int, val subOffsetLen: Option[Int] = None)(implicit p: Parameters) extends WXBundle with FTBParams {
...
class FTBEntry(implicit p: Parameters) extends WXBundle with FTBParams with BPUUtils {
